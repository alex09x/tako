//
//  TakoWindowPositionUITests.swift
//  TakoUITests
//
...
final class TakoWindowPositionUITests: TakoCustomConfigCase {
    // MARK: - Cascading
    ...
    @MainActor func testWindowCascading() async throws {
        try updateConfig(
            ...
            window-width = 30
            window-height = 10
            title = "TakoWindowPositionUITests"
            """
        )
        ...
        // Clean run
        app.launchEnvironment["TAKO_CLEAR_USER_DEFAULTS"] = "YES"
