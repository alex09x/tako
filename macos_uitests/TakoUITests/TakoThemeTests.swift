...
final class TakoThemeTests: TakoCustomConfigCase {
    override static var runsForEachTargetApplicationUIConfiguration: Bool {
        true
    }

    let windowTitle = "TakoThemeTests"
    ...
    func testQuickTerminalThemeChange() async throws {
        ...
        let title = "Debug builds of Tako are very slow and you may experience performance problems. Debug builds are only recommended during development."
