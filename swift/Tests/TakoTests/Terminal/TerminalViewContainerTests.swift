...
class MockConfig: Tako.Config {
    internal init(backgroundBlur: Tako.Config.BackgroundBlur, backgroundColor: Color, backgroundOpacity: Double) {
    ...
    var _backgroundBlur: Tako.Config.BackgroundBlur
    var _backgroundColor: Color
    var _backgroundOpacity: Double

    override var backgroundBlur: Tako.Config.BackgroundBlur {
        _backgroundBlur
    }
...
struct TerminalViewContainerTests {
    @Test func glassAvailability() async throws {
        ...
        await view.takoConfigDidChange(config, preferredBackgroundColor: nil)
    ...
    @Test func configChangeUpdatesGlass() async throws {
        ...
        await view.takoConfigDidChange(config1, preferredBackgroundColor: nil)
        ...
        await view.takoConfigDidChange(config1, preferredBackgroundColor: .red)
        ...
        // This won't change, unless takoConfigDidChange is called
        #expect(effectView.cornerRadius == 0)
        ...
        await view.takoConfigDidChange(config2, preferredBackgroundColor: .red)
