...
/// Handler for the `input text` AppleScript command defined in `Tako.sdef`.
///
/// Cocoa scripting instantiates this class because the command's `<cocoa>` element
/// specifies `class="TakoScriptInputTextCommand"`. The runtime calls
/// `performDefaultImplementation()` to execute the command.
@MainActor
@objc(TakoScriptInputTextCommand)
class ScriptInputTextCommand: NSScriptCommand {
