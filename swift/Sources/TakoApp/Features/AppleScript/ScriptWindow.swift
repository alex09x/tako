...
/// AppleScript-facing wrapper around a logical Tako window.
///
...
final class ScriptWindow: NSObject {
    ...
    private var controllers: [BaseTerminalController] {
        ...
        let groupControllers = Tako.CustomTabGroup.group(for: window).windows.compactMap {
    ...
    private var selectedController: BaseTerminalController? {
        ...
        if let selectedController = Tako.CustomTabGroup.group(for: window).selectedWindow?.windowController as? BaseTerminalController {
    ...
    func handleActivateWindow(_ command: NSScriptCommand) -> Any? {
        ...
        Tako.CustomTabGroup.group(for: windowContainer).select(windowContainer)
...
extension ScriptWindow {
    ...
    static func stableID(primaryController: BaseTerminalController) -> String {
        ...
        return stableID(tabGroup: Tako.CustomTabGroup.group(for: window))
    }
    ...
    /// Stable ID for a custom tab group.
    static func stableID(tabGroup: Tako.CustomTabGroup) -> String {
