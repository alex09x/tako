...
final class TabTitleEditor: NSObject, NSTextFieldDelegate {
    ...
    func beginEditing(for targetWindow: NSWindow) -> Bool {
        ...
        let sourceLabel = Self.sourceTabTitleLabel(from: tabState.labels.map(\.label), matching: editedTitle)
    ...
    static func sourceTabTitleLabel(from labels: [NSTextField], matching title: String) -> NSTextField? {
